    ...
    <form class="form-horizontal m" id="form_test_position_update">
        <input id="id" name="id" type="hidden" value="${testPosition.id}">
            ...
            <div class="form-group">
                ...
                <div class="col-sm-8">
                        <input class="form-control required" type="text" name="positionText" value="${testPosition.positionText}"
            ...
            <div class="form-group">
                ...
                <div class="col-sm-8">
                        <input class="form-control required" type="text" name="socialBenefits" value="${testPosition.socialBenefits}"
            ...
            <div class="form-group">
                ...
                <div class="col-sm-8">
                        <input class="form-control required" type="text" name="salary" value="${testPosition.salary}"
            ...
            <div class="form-group">
                ...
                <div class="col-sm-8">
                        <input class="form-control required" type="text" name="states" value="${testPosition.states}"
