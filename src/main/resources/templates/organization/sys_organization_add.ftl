...
<div class="wrapper wrapper-content animated fadeInRight ibox-content">
    <form class="form-horizontal m" id="form_sys_organization_add">
            ...
            <div class="form-group">
                ...
                <div class="col-sm-8">
                    <input class="form-control required" type="text" name="sort"
...
<script type="text/javascript">
    ...
    $("#form_sys_organization_add").validate({
        onkeyup: false,
        ignore: ":hidden",
        ignore: "",
        rules: {
    ...
    function submitHandler() {
        if ($.validate.form()) {
            $.operate.save(prefix + "/add", $('#form_sys_organization_add').serialize());
        }
    }
</script>
</body>
