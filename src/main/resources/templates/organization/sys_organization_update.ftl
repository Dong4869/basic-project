...
<div class="wrapper wrapper-content animated fadeInRight ibox-content">
    <form class="form-horizontal m" id="form_sys_organization_update">
        <input id="id" name="id" type="hidden" value="${sysOrganization.id}">
            ...
            <div class="form-group">
                ...
                <div class="col-sm-8">
                        <input class="form-control required" type="text" name="sort" value="${sysOrganization.sort}"
...
<script type="text/javascript">
    ...
    $("#form_sys_organization_update").validate({
        onkeyup: false,
        ignore: ":hidden",
        ignore: "",
        rules: {},
    ...
    function submitHandler() {
        if ($.validate.form()) {
            $.operate.save(prefix + "/update", $('#form_sys_organization_update').serialize());
        }
    }
</script>
</body>
